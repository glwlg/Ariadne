...
- 正确构建目录：`P:\workspace\glwlg\app\x-tools`

### 最新 app 产物

- exe：`P:\workspace\glwlg\app\x-tools\bin\ariadne.exe`
- 大小：`32534528` bytes
- 更新时间：`2026-06-16 21:50:57`
- SHA256：`957A2A490193A6DD658F020FD3963C601B0F195E463399521A730EF74DF6659A`
- release zip：`P:\workspace\glwlg\app\x-tools\dist\release\ariadne-dev-windows-x64.zip`
- release zip 大小：`16987699` bytes
- release zip 更新时间：`2026-06-16 21:50:58`
- release zip SHA256：`CD5A45D44B23C783795E73627EB0737BA3A1777DF3F650FF73C469A6C898EC24`
- MSIX layout：`P:\workspace\glwlg\app\x-tools\dist\msix\ariadne-0-0-0-0-msix`
- MSIX manifest：`P:\workspace\glwlg\app\x-tools\dist\msix\ariadne-0-0-0-0-msix\msix-manifest.json`
